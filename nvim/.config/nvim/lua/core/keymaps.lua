...
map('n', '<M-N>', '<cmd>vertical resize -5<CR>', opts)
map('n', '<M-I>', '<cmd>vertical resize +5<CR>', opts)
...
-- Move Block
map('v', '+', ":m '>+1<CR>gv=gv", { noremap = true, silent = true })
map('v', '-', ":m '<-2<CR>gv=gv", { noremap = true, silent = true })
