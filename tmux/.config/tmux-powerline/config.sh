...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="gruvbox_material_dark_medium"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/radish/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/radish/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/radish/.now_playing.log"
...
# time.sh {
	...
	export TMUX_POWERLINE_SEG_TIME_FORMAT="%D %R"
