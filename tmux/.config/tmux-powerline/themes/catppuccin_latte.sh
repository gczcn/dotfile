...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#e6e9ef'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#fe640b'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #8839ef #e6e9ef"
		# "hostname #ccd0da #8839ef"
		#"mode_indicator 165 0"
		# "ifstat 30 255"
		"lan_ip #ccd0da #8839ef ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "wan_ip 24 255"
		"vcs_branch #40a02b #e6e9ef"
		"vcs_compare #8839ef #e6e9ef"
		"vcs_staged #df8e1d #e6e9ef"
		"vcs_modified #d20f39 #e6e9ef"
		"vcs_others ##4c4f69 #e6e9ef"
		# "ifstat_sys #ccd0da #8839ef"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"rainbarf_rgb"
		"time #40a02b #e6e9ef ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
