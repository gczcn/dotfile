...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#343f44'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#a7c080'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #e69875 #2d353b"
		# "hostname #475258 #9da9a0"
		# "mode_indicator #a7c080 #2d353b"
		# "ifstat 30 255"
		"lan_ip #475258 #9da9a0 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "wan_ip #475258 #9da9a0"
		"vcs_branch #a7c080 #2d353b"
		"vcs_compare #d699b6 #2d353b"
		"vcs_staged #a7c080 #2d353b"
		"vcs_modified #e67e80 #2d353b"
		"vcs_others #d3c6aa #2d353b"
		# "ifstat_sys #475258 #9da9a0"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"rainbarf_rgb"
		"time #7fbbb3 #2d353b ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
