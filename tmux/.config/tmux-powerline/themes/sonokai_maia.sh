...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#313b42'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#e3d367'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #f3a96a #273136"
		# "hostname #414b53 #e1e2e3"
		# "mode_indicator #9cd57b #273136"
		# "ifstat 30 255"
		"lan_ip #414b53 #e1e2e3 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "wan_ip #414b53 #e1e2e3"
		"vcs_branch #9cd57b #273136"
		"vcs_compare #baa0f8 #273136"
		"vcs_staged #9cd57b #273136"
		"vcs_modified #f76c7c #273136"
		"vcs_others #e1e2e3 #273136"
		# "ifstat_sys #414b53 #e1e2e3"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"rainbarf_rgb"
		"time #9cd57b #273136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
