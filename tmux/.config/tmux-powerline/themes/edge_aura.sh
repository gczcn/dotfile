...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#333644'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#deb974'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #6cb6eb #2b2d37"
		# "hostname #404455 #c5cdd9"
		# "mode_indicator #a0c980 #2b2d37"
		# "ifstat 30 255"
		"lan_ip #404455 #c5cdd9 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "wan_ip #404455 #c5cdd9"
		"vcs_branch #a0c980 #2b2d37"
		"vcs_compare #d38aea #2b2d37"
		"vcs_staged #a0c980 #2b2d37"
		"vcs_modified #ec7279 #2b2d37"
		"vcs_others #c5cdd9 #2b2d37"
		# "ifstat_sys #404455 #c5cdd9"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"rainbarf_rgb"
		"time #a0c980 #2b2d37 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
