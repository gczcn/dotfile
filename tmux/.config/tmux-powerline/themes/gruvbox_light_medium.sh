...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#ebdbb2'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#7c6f64'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #076678 #f9f5d7"
		# "hostname #d5c4a1 #7c6f64"
		# "mode_indicator #79740e #f9f5d7"
		# "ifstat 30 255"
		"lan_ip #d5c4a1 #7c6f64 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "wan_ip #504945 #ebdbb2"
		"vcs_branch #79740e #f9f5d7"
		"vcs_compare #8f3f71 #f9f5d7"
		"vcs_staged #79740e #f9f5d7"
		"vcs_modified #9d0006 #f9f5d7"
		"vcs_others #7c6f64 #f9f5d7"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"rainbarf"
		"time #79740e #f9f5d7 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
